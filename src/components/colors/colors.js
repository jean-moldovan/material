  ...
  function MdColorsDirective($mdColors, $mdUtil, $log) {
    return {
      ...
      compile: function(tElem, tAttrs) {
        ...
        var mdColorsWatch = angular.isDefined(tAttrs.mdColorsWatch) ? $mdUtil.parseAttributeBoolean(tAttrs.mdColorsWatch) : true;
        var shouldWatch = !STATIC_COLOR_EXPRESSION.test( rawColorExpression ) && mdColorsWatch;
